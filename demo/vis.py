...
from model.trans import ICFNet as Model
...
def get_pose3D(video_path, output_dir, fix_z):
    ...
    args.layers, args.channel, args.d_hid, args.token_dim, args.frames = 3, 128, 1024, 256, 1
    args.pad = (args.frames - 1) // 2
    args.previous_dir = 'checkpoint/mymodule'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fix_z', default='store_true', help='fix z axis')
