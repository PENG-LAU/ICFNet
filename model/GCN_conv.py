...
class ModulatedGraphConv(nn.Module):
    ...
    def __init__(self, in_features, out_features, adj, bias=True):
        ...
        self.W = nn.Parameter(torch.zeros(size=(2, in_features, out_features), dtype=torch.float))  # torch.Size([2,in_features, out_features])
    ...
    def forward(self, input):
        h0 = torch.matmul(input, self.W[0])  # input 256,17,in_feature  -> 256,17,out_feature
